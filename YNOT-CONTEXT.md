...
> Use this file when brainstorming in Claude.ai. It is the single source of truth for the platform's purpose, architecture, data sources, and current state. Keep it updated after significant changes.
